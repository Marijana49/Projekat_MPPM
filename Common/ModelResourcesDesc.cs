...
{	
	...
	public class ModelResourcesDesc
	{
		...
		{			
			typeIdsInInsertOrder.Add(ModelCode.PERLENGTHSEQIM);
		...
		{			
            ...
            notSettablePropertyIds.Add(ModelCode.TERMINAL_CE);
            notSettablePropertyIds.Add(ModelCode.TERMINAL_CN);
            notSettablePropertyIds.Add(ModelCode.AC_PLI);
		}
